...
Head to [examples/lumen-app](https://github.com/moneyplatform/laravel-prometheus-exporter/tree/example-application/examples/lumen-app)
to check out our awesome example application.
To get it you'll have to clone the [Laravel Prometheus Exporter](https://github.com/moneyplatform/laravel-prometheus-exporter/) repo, as the example
...
"repositories": [
  {
    "type": "vcs",
    "url": "https://github.com/moneyplatform/laravel-prometheus-exporter"
  }
],
```
...
```bash
composer require moneyplatform/laravel-prometheus-exporter
```
...
$userAliases = [
    // ...
    Moneyplatform\LaravelPrometheusExporter\PrometheusFacade::class => 'Prometheus',
];
...
```php
$app->register(Moneyplatform\LaravelPrometheusExporter\PrometheusServiceProvider::class);
```
...
$app->loadComponent('prometheus', [
    Moneyplatform\LaravelPrometheusExporter\PrometheusServiceProvider::class
]);
```
...
```php
$app->middleware([
    Moneyplatform\LaravelPrometheusExporter\RouteMiddleware::class,
]);
```
...
```php
$app->register(Moneyplatform\LaravelPrometheusExporter\GuzzleServiceProvider::class);
```
...
```php
$app->register(Moneyplatform\LaravelPrometheusExporter\DatabaseServiceProvider::class);
```
...
$exporter = app(\Moneyplatform\LaravelPrometheusExporter\PrometheusExporter::class);
